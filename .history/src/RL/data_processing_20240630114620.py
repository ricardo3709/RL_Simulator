...
def feature_preparation(state):
    ...
    request_gen_counts_areas_col = torch.tensor(request_gen_counts).to(device)
    request_rej_counts_areas_col = torch.tensor(request_rej_counts).to(device)
    request_attraction_counts_areas_col = torch.tensor(request_attraction_counts).to(device)
