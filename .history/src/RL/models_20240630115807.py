...
class DDPG_Agent(nn.Module):
    ...
    def update_policy(self, action, reward, state_encoded, edge_index):
        ...
        if not isinstance(state_encoded, torch.Tensor):
            state_encoded = torch.FloatTensor(state_encoded)
