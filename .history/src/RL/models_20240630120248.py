...
class DDPG_Agent(nn.Module):
    ...
    def update_policy(self, action, reward, current_laste, last_state, edge_index):
        ...
        current_state_encoded = self.gnn_encoder(graph_current_state)
        last_state_encoded = self.gnn_encoder(graph_last_state)
