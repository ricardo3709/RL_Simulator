...
class ManhattanTrafficEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.n_steps_delay = self.config.get("RL_DURATION")*2 # delay for one whole simulation
    ...
    def step(self, action):
        ...
        print(f"Reward: {reward}, no updating")
        # 应用动作调整系数
    ...
    def calculate_reward(self, past_rejections):
        ...
        current_avg_rej = np.mean(past_rejections[-RL_DURATION:])
